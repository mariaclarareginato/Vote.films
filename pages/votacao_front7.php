...
if (basename($_SERVER['PHP_SELF']) !== 'votacao_front7.php') {
    header("Location: votacao_front7.php");
    exit;
}
...
if (!isset($_SESSION['filmes'])) {
    $_SESSION['filmes'] = [
        ['nome' => 'Grinch', 'imagem' => 'grinch.jpg'],
        ['nome' => 'O estranho mundo de Jack', 'imagem' => 'o_estranho_mundo_de_jack.jpg'],
        ['nome' => 'Klaus', 'imagem' => 'klaus.jpg'],
        ['nome' => 'A origem dos guardiões', 'imagem' => 'a_origem_dos_guardiões.jpg'],
        ['nome' => 'Crônicas de natal', 'imagem' => 'cronicas_de_natal.jpg'],
        ['nome' => 'Esqueceram de mim', 'imagem' => 'esqueceram_de_mim.webp'],
        ['nome' => 'Tudo bem no natal que vem', 'imagem' => 'tudo_bem_no_natal_que_vem.jpg'],
        ['nome' => 'O expresso polar', 'imagem' => 'o_expresso_polar.jpg'],
        ['nome' => 'Anjo de natal', 'imagem' => 'anjo_de_natal.jpg'],
        ['nome' => 'Deixe a neve cair', 'imagem' => 'deixe_a_neve_cair.jpg'],
        ['nome' => 'A batalha de natal', 'imagem' => 'a_batalha_de_natal.jpg'],
        ['nome' => 'Um natal quase perfeito', 'imagem' => 'um_natal_quase_perfeito.jpg'],
    ];
}
...
<body>
    <header class= 'header-votacao'>
        <a href='../pages/generos.html'>  
            ...
            <img src='../assets/img/filmes/natalinos/{$vencedor['imagem']}' alt='{$vencedor['nome']}' class='img-vencedor'>
          </div>
</body>
    ...
    <main class="main">
        ...
        <div class="opcoes">
            <?php foreach ($_SESSION['em_votacao'] as $key => $filme): ?>
                <a href="votacao_front7.php?voto=<?= $key ?>">
                    <input type="image" src="../assets/img/filmes/natalinos/<?= $filme['imagem'] ?>" 
        ...
        <div class="reset">
            <a href="votacao_front7.php?reset=true">Reiniciar Votação</a>
        </div>
    </main>
</body>
